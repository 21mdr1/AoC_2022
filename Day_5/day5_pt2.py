...
for move in moves:
    ...
    #add crates to end_column
    arrangement[end_column].extend(arrangement[start_column][-number_of_crates:])
    #remove crates from start_column
    del arrangement[start_column][-number_of_crates:]
